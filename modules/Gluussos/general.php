    ...
    <div class="container">
        ...
        <div class="container-page">
                        ...
                        <form id="register_GluuOxd" name="f" method="post"
                            ...
                            <div class="login_GluuOxd">
                                ...
                                <div class="mess_red">If you do not have an OpenID Connect provider, you may want to look at the Gluu Server (
                                    <a target="_blank" href="http://www.gluu.org/docs">Like SugarCRM, there is a free open source Community Edition. For more information about Gluu Server support please visit <a target="_blank" href="http://www.gluu.org">our website.</a></a>)
                                </div>
                                <div class="mess_red">
                                    <h3>Instructions to Install oxd server</h3>
                                    <br><b>NOTE:</b> The oxd server should be installed on the same server as your SugarCRM site. It is recommended that the oxd server listen only on the localhost interface, so only your local applications can reach its API's.
                            ...
                            <div class="entry-edit" >
                                ...
                                <div class="fieldset">
                                    <div class="hor-scroll">
                                        ...
                                        <p>
                                            The OP enables a client (like a SugarCRM site), to signal which type of authentication should be
            ...
            <div class="page" id="helptrouble">
                ...
                <h1><a id="SugarCRM_GLUU_SSO_module_0"></a>SugarCRM OpenID Connect Single Sign-On (SSO) Module by Gluu</h1>
                <p><img src="https://raw.githubusercontent.com/GluuFederation/gluu-sso-SugarCRM-module/master/plugin.jpg" alt="image"></p>
                <p>Gluu's SugarCRM OpenID Connect Single Sign On (SSO) Module will enable you to authenticate users against any standard OpenID Connect Provider (OP). If you don't already have an OP you can [deploy the free open source Gluu Server](https://gluu.org/docs/deployment).</p>

                <h2><a id="Step_1_Install_Gluuserver_13"></a>Step 1. Install</h2>
                <p>In order to use the SugarCRM Module, you will need to have deployed a standard OP like the Gluu Server and the oxd Server.</p>
                ...
                <p><img src="https://raw.githubusercontent.com/GluuFederation/gluu-sso-SugarCRM-module/master/docu/15.png" alt="General"></p>
                <ol>
                ...
                <p>In the Module interface you can enable, disable and delete scopes. You can also add new scopes. If/when you add new scopes via the module, be sure to also add the same scopes in your gluu server.
                    <img src="https://raw.githubusercontent.com/GluuFederation/gluu-sso-SugarCRM-module/master/docu/d9.png" alt="Scopes1"></p>
                ...
                <ol>
                    <li>- The authentication mechanism specified in your SugarCRM module page must match the authentication mechanism specified in your Gluu Server.</li>
                    <li>- After saving the authentication mechanism in your Gluu Server, it will be displayed in the SugarCRM Module configuration page too.</li>
                ...
                <h3><a id="Customize_Login_Icons_121"></a>Once you've configured all the options, you should see your supported authentication mechanisms on your default SugarCRM login page like the screenshot below</h3>
