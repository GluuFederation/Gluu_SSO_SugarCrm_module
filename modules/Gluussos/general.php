                                    ...
                                    <div style="padding-left: 10px;">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="button button-primary button-large" style="text-decoration:none; text-align:center; float: right; width: 120px" href="index.php?module=Gluussos&action=generalEdit">Edit</a></td>
                                                <td>
                                                    <div><input type="submit" onclick="return confirm('Are you sure that you want to remove this OpenID Connect provider? Users will no longer be able to authenticate against this OP.')" name="resetButton" value="Delete" style="width: 120px;" class="button button-danger button-large"/></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
