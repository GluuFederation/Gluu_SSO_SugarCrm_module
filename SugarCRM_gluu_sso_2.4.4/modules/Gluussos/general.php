    ...
    <div class="container">
        ...
        <div class="container-page">
            ...
            <div class="page" id="helptrouble">
                ...
                <p>There are already 2 versions of SUGARCRM-GLUU-SSO (2.4.2, 2.4.3 and 2.4.4) modules, each in its turn is working with oxD and GLUU servers.
                    For example if you are using SUGARCRM-gluu-sso-2.4.4 module, you need to connect with oxD-server-2.4.4.</p>
                ...
                <p>OpenID Connect Configuration page for SugarCRM-gluu-sso 2.4.4.</p>
                ...
                <p>In SugarCRM-gluu-sso 2.4.4  you can add, enable, disable and delete scope.
